...
#ifndef __R3__SURFEL__LABEL__RELATIONSHIP__H__
#define __R3__SURFEL__LABEL__RELATIONSHIP__H__
...
public:
  ...
  R3SurfelLabelRelationship& operator=(const R3SurfelLabelRelationship& relationship);
